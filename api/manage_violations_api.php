...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && ($_GET['action'] ?? '') === 'get_data') {
    $current_school_year = get_current_school_year($pdo);
    ...
    $violations = $stmtList->fetchAll(PDO::FETCH_ASSOC);
    ...
    echo json_encode([
        ...
        'timeline' => [
            ...
            'end_hk1_date' => $end_hk1_date,
            'end_year_date' => $end_year_date,
            'excluded_dates' => $excluded_dates_string,
            'current_week' => $current_week
        ],
        'violations' => $violations,
        'rules' => $rules,
        'ticker_school' => $ticker_school
    ]);
    exit;
}
