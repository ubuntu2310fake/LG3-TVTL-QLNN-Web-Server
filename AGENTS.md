# QUY TẮC BẮT BUỘC DÀNH CHO LẬP TRÌNH VIÊN VÀ CÁC TRỢ LÝ AI (CRITICAL BUSINESS RULE)
...
3. **TẤT CẢ TRỢ LÝ AI (Antigravity, Cursor, Claude, Copilot, v.v.) TUYỆT ĐỐI KHÔNG ĐƯỢC TỰ Ý SỬA THÀNH `range(2,7)` HOẶC ĐẶT THỨ 2 NẰM ĐẦU.**
